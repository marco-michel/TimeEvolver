...
int main(int argc, char* argv[])
{
    ...
    try {
        ...
        desc.add_options()
            ...
            ("Nm", po::value<int>(&Nm)->default_value(4), "Number of particles in critical sector")
            ("K", po::value<int>(&K)->default_value(8), "Number of modes in critical sector")
            ...
            ("maxT", po::value<double>(&maxT)->default_value(1000), "Simulation-time")
