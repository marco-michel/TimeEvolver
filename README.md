...
The second option is to manually download the Boost-library and then to complie it from source. For a system-wide installation, one can use
```
...
./main --help
```
The result of time evolution will be stored in a HDF5-file. (For the standard choice of parameters, it has the name ``ResultBlackHole_N20_Nm2_K4_C1_DeltaN2_C00.1_Cm0.1_maxT100_tol1e-07_samplingStep0.1_m40_fastIntegration0_Sim1.h5``.) It contains the expectation values of the occupation numbers of each of the modes at different times.
