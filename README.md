...
## Basic setup without installation
...
```
**Note that the above procedures will fail if you do not have at least version 1.75 of Boost. Below we describe how to solve this issue.**
